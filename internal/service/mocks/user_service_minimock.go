...
//go:generate minimock -i github.com/solumD/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
func (mmGetUser *mUserServiceMockGetUser) Set(f func(ctx context.Context, userID int64) (up1 *model.User, err error)) *UserServiceMock {
	if mmGetUser.defaultExpectation != nil {
...
func (mmGetUser *UserServiceMock) GetUser(ctx context.Context, userID int64) (up1 *model.User, err error) {
...
func (mmUpdateUser *mUserServiceMockUpdateUser) Expect(ctx context.Context, user *model.UserUpdate) *mUserServiceMockUpdateUser {
...
func (mmUpdateUser *mUserServiceMockUpdateUser) ExpectUserParam2(user *model.UserUpdate) *mUserServiceMockUpdateUser {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserServiceMock.UpdateUser mock is already set by Set")
	}
...
func (mmUpdateUser *mUserServiceMockUpdateUser) Inspect(f func(ctx context.Context, user *model.UserUpdate)) *mUserServiceMockUpdateUser {
...
func (mmUpdateUser *mUserServiceMockUpdateUser) Set(f func(ctx context.Context, user *model.UserUpdate) (ep1 *emptypb.Empty, err error)) *UserServiceMock {
	if mmUpdateUser.defaultExpectation != nil {
...
// Then helper
func (mmUpdateUser *mUserServiceMockUpdateUser) When(ctx context.Context, user *model.UserUpdate) *UserServiceMockUpdateUserExpectation {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserServiceMock.UpdateUser mock is already set by Set")
	}
...
func (mmUpdateUser *UserServiceMock) UpdateUser(ctx context.Context, user *model.UserUpdate) (ep1 *emptypb.Empty, err error) {
	...
	if mmUpdateUser.UpdateUserMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.user != nil && !minimock.Equal(*mm_want_ptrs.user, mm_got.user) {
				mmUpdateUser.t.Errorf("UserServiceMock.UpdateUser got unexpected parameter user, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
